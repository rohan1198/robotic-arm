...
#include "robotic_arm/robotic_arm_hardware.hpp"
#include <string>
#include <vector>

namespace robotic_arm
{
CallbackReturn RoboticArmSystem::on_init(const hardware_interface::HardwareInfo & info)
{
...
std::vector<hardware_interface::StateInterface> RoboticArmSystem::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> RoboticArmSystem::export_command_interfaces()
{
...
return_type RoboticArmSystem::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
...
return_type RoboticArmSystem::write(const rclcpp::Time &, const rclcpp::Duration &)
{
  return return_type::OK;
}
...
PLUGINLIB_EXPORT_CLASS(
  robotic_arm::RoboticArmSystem, hardware_interface::SystemInterface
)
