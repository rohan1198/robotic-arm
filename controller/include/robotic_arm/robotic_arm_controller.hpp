...
#ifndef ROBOTIC_ARM__ROBOTIC_ARM_CONTROLLER_HPP_
#define ROBOTIC_ARM__ROBOTIC_ARM_CONTROLLER_HPP_
...
{
class RoboticArmController : public controller_interface::ControllerInterface
{
public:
...
#endif  // ROBOTIC_ARM__ROBOTIC_ARM_CONTROLLER_HPP_
